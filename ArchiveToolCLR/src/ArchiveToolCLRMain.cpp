...
ref class ArchiveToolCLR {
   public:
    ...
    static bool ArchiveExtraTestCLR(String ^ file) { return ArchiveExtraTestCLR(file, ""); }

    static String ^
        CheckFormatCLR(String ^ filepath) {
